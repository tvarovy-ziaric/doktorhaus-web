...
try {
    ...
    mutateManifest($wrongHash, function (array &$manifest): void {
    ...
    foreach (['C:/private/file.json', '/private/file.json', 'https://example.invalid/file.json', '..\\private\\file.json', '\\\\server\\share\\file.json', 'media//file.json', 'NUL', 'media/file.', 'bad' . "\0" . 'name'] as $unsafePath) {
